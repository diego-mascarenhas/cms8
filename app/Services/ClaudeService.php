...
class ClaudeService
{
    ...
    private function extractPhoneNumberFromHistory($history = [])
    {
        ...
        // Get system phone numbers from team configuration
        $systemPhones = $this->getSystemPhoneNumbers();
        $clientPhones = [];
    ...
    /**
     * Get system phone numbers from current team's Twilio configuration
     */
    private function getSystemPhoneNumbers()
    {
        $systemPhones = [];
        ...
        return array_unique($systemPhones);
    }
}
