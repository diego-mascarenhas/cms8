...
class UpdateProjectApiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data.token_model' => ['nullable', 'array'],
            'data.token_model.id' => ['nullable', 'string', 'max:255'],
            'data.token_model.name' => ['nullable', 'string', 'max:255'],
            'data.token_model.prompt_per_million' => ['nullable', 'numeric', 'min:0'],
            'data.token_model.completion_per_million' => ['nullable', 'numeric', 'min:0'],
