...
class UpdateTeamSettingsRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email.mail_from_address' => 'required_with:email|email|max:255',
            'email.mail_from_name' => 'required_with:email|string|max:255',
            'email.mailer_from_address' => 'nullable|email|max:255',
            'email.mailer_from_name' => 'nullable|string|max:255',
