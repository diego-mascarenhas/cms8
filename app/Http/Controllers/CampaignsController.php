        ...
        return view('campaigns.templates-select', [
            ...
            'kajabiTemplates' => [
                [
                    ...
                    'full_preview' => 'https://placehold.co/1300x1800/f6f7fb/a0a5b1?text=Squiggle',
                ],
                [
                    'id' => 102,
                    'name' => 'Slice',
                    ...
                    'full_preview' => 'https://placehold.co/1300x1800/f6f7fb/a0a5b1?text=Slice',
                ],
                [
                    'id' => 103,
                    'name' => 'Timber',
                    ...
                    'full_preview' => 'https://placehold.co/1300x1800/f6f7fb/a0a5b1?text=Timber',
                ],
                [
                    'id' => 104,
                    'name' => 'Brush',
                    ...
                    'full_preview' => 'https://placehold.co/1300x1800/f6f7fb/a0a5b1?text=Brush',
                ],
                [
                    'id' => 105,
                    'name' => 'Mocha',
