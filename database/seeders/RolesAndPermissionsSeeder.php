...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run()
    {
         ...
         * ==================================================================================
         *
         * The application has been refactored to use role-based authorization with Laravel
         * Policies instead of granular permission checks. All permission creation has been
         * commented out but kept for reference in case of rollback.
         *
         ...
         * - Blade directives: @role() and @can('action', $model)
         *
         * Database tables remain intact for potential rollback.
         * ==================================================================================
         */

        // All permission creation has been disabled - see comment above
        // Permission statements have been commented out throughout this file
