...
class DemoPerformanceInsightsSeeder extends Seeder
{
    ...
    private function demoEmailFixtures(): array
    {
        ...
        return [
            ...
            [
                'message_key' => 'digest-webhook-json',
                'subject' => 'Event payload — Stripe webhook',
                'from' => 'Webhook <webhook@example.com>',
                'body' => '{"event":"invoice.paid","amount":1200,"customer":{"name":"Marina","email":"administracion@revisionalpha.com"}}',
                'hours_ago' => 3,
                'seen' => false,
                'folder' => EmailFolder::Inbox->value,
            ],
