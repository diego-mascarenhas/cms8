...
class MailerPaygPricingTest extends TestCase
{
    ...
    {
        $this->assertSame('0.002', MailerPaygPricing::pricePerEmail());
        ...
        $this->assertSame(0, MailerPaygPricing::overageDueCents(1));
        $this->assertSame(40, MailerPaygPricing::overageDueCents(200));
    }
}
