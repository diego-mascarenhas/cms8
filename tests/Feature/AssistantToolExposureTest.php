...
class AssistantToolExposureTest extends TestCase
{
    ...
    public function test_whatsapp_catalog_exposes_only_sales_tools(): void
    {
        ...
        $this->assertEqualsCanonicalizing(
            ['list_product_catalog', 'search_products', 'send_product_image', 'add_to_whatsapp_cart', 'view_whatsapp_cart', 'get_store_info', 'confirm_whatsapp_order', 'search_contacts', 'get_contact_detail', 'create_contact', 'update_contact', 'list_contact_categories', 'get_contact_categories', 'assign_contact_to_category'],
            $names,
        );
