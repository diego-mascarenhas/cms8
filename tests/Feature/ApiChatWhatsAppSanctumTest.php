...
class ApiChatWhatsAppSanctumTest extends TestCase
{
    ...
    public function test_whatsapp_messages_exposes_assistant_token_usage(): void
    {
        ...
        $response->assertJsonPath('messages.0.usage.prompt_tokens', 120000);
        $response->assertJsonPath('messages.0.usage.completion_tokens', 1800);
        $response->assertJsonPath('messages.0.usage.total_tokens', 121800);
    ...
    public function test_whatsapp_messages_reads_token_usage_from_outbound_metadata(): void
    {
        ...
        $this->withHeader('Authorization', 'Bearer '.$user->createToken('test')->plainTextToken)
            ...
            ->assertOk()
            ->assertJsonPath('messages.0.usage.total_tokens', 8400)
