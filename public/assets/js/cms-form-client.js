  ...
  if (typeof wizardIcons !== undefined && wizardIcons !== null) {
    ...
    if (wizardIconsBtnSubmit) {
      wizardIconsBtnSubmit.addEventListener('click', event => {
        ...
        alert('Submitted..!!'); // Muestra la alerta
        const form = wizardIcons.querySelector('form'); // Obtiene la referencia al formulario
        form.submit(); // Envía el formulario de manera tradicional
      });
    }
  }
