...
return [
    ...
    'registration' => [
        ...
        'qr_description' => 'Tu plan ya está activo. Seguí los pasos en tu teléfono y usa el código QR de abajo para vincular WhatsApp.',
        ...
        'qr_whatsapp_steps_chat' => [
            'Escanea el código QR de abajo para abrir Humano en tu móvil.',
            'Abre la app de WhatsApp en ese mismo teléfono.',
            'Tocá Menú (⋮) o Ajustes → Dispositivos vinculados → Vincular un dispositivo.',
            'Cuando se abra la cámara, usa el código QR que te muestre Humano y confirmá en WhatsApp si te lo piden.',
        ],
