...
return [
    ...
    'groups' => [
        ...
        'paid_ads' => [
            'title' => 'Paid-Ads-Plattformen',
            'subtitle' => 'Konfiguriere die API-Zugangsdaten für Google, Meta, LinkedIn, TikTok und X.',
        ],
        'calendar' => [
            'title' => 'Calendario',
    ...
    'site_assistant' => [
        ...
        'select_off_all' => 'Sin asistente (también conversaciones existentes)',
        'select_empty' => 'Router automático (sin prompt fijo)',
        'select_help' => 'No responde por defecto = WhatsApp calla salvo que el chat tenga un prompt. También existentes = pausa todo, incluso esos prompts (no los borra). Router = clasifica solo. Un prompt fijo habla de citas, catálogo y compra.',
        'select_group_start' => 'Cómo arranca',
        'select_group_catalog' => 'Defaults del sistema',
        'select_group_team' => 'En mi equipo',
        ...
        'paused_reply' => 'Recibimos tu mensaje. Un asesor del equipo te responde en breve.',
    ],
];
