...
return [
    ...
    'Google accounts col_abbr_user' => 'User',
    'Google accounts col_tip_user' => 'User: Humano user linked to this Google connection (name and email appear in each row).',
    'Google accounts col_abbr_calendar' => 'Cal.',
    'Google accounts col_tip_calendar' => 'Calendar (Google): permission level for Google Calendar on this connection.',
    'Google accounts col_abbr_contacts' => 'Cont.',
    'Google accounts col_tip_contacts' => 'Contacts (Google): permission level for Google Contacts on this connection.',
    'Google accounts col_abbr_sync' => 'Sync',
    'Google accounts col_tip_sync' => 'Last account sync (contacts + calendar jobs): when sync jobs last finished successfully for this connection.',
    'Google accounts col_abbr_scopes' => 'Scopes',
    'Google accounts col_tip_scopes' => 'Granted OAuth scopes: URLs accepted at connect time (listed per row below).',
