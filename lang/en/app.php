...
return [
    ...
    'Google calendar sync help body' => 'This page lists Google Calendar events that have been linked to local rows in Humano. The main calendar only shows local rows that are not soft-deleted; this screen shows the mapping so you can see cancelled or removed copies.',
    'How Google contacts sync works' => 'How Google contacts sync works',
    'Google contacts sync help body' => 'Each row is a Google People resource id mapped to a CRM contact. Names and emails shown are the local copy in Humano (we do not store the remote display name separately).',
