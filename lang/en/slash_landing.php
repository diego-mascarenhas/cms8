...
return [
    ...
    'features' => [
        [
            ...
            'text' => 'Deja macros opacos y permisos confusos. Toda la empresa ve la misma información con roles claros.',
        ],
        [
            'icon' => 'check.png',
            'title' => 'Los datos son tuyos',
            'text' => 'Servidores en Europa. Exporta y llévate tus datos cuando quieras, sin límites.',
        ],
        [
            'icon' => 'rocket.png',
            'title' => 'Menos gestión, más vida',
            'text' => 'Procesos probados sin inventarlos tú. Humano.app acelera la operativa desde el primer día.',
        ],
        [
            'icon' => 'cloud.svg',
            'title' => 'Sistema en la nube',
            'text' => 'Accede desde móvil, tablet u ordenador desde cualquier parte del mundo.',
        ],
        [
            'icon' => 'user.png',
            'title' => 'Control por WhatsApp',
            'text' => 'Gestiona tu negocio desde WhatsApp. Tú das las órdenes, Humano.app responde.',
        ],
        [
            'icon' => 'keyboard.png',
    ...
    'capability_items' => [
        [
            ...
            'text' => 'Conecta tu línea, responde desde el panel y automatiza lo repetitivo sin salir de Humano.',
        ],
        [
            'title' => 'Roles y permisos',
            'text' => 'Define quién ve qué: ventas, operaciones, finanzas. Sin macros ni hojas compartidas a ciegas.',
        ],
        [
            'title' => 'Multi-equipo',
            'text' => 'Cambia entre espacios de trabajo como entre servidores: cada negocio con su marca, datos y flujos.',
        ],
    ],
    'tool_items' => [
        [
        ...
        [
            'title' => 'Prospección',
            'text' => 'Busca perfiles por cargo y ubicación e impórtalos a tu agenda.',
        ],
        [
        ...
        [
            'title' => 'Landings',
            'text' => 'Convierte visitas en contactos con páginas enlazadas al CRM.',
        ],
        [
            'title' => 'Facturación',
            'text' => 'Emite y sigue cobros sin cambiar de herramienta.',
        ],
        [
            'title' => 'Exportación',
            'text' => 'Tus datos son tuyos: exporta cuando quieras, sin límites.',
        ],
    ],
    'trust_cards' => [
        [
    ...
    'security_items' => [
        ...
        [
            ...
            'text' => 'Exporta tu información cuando quieras. Sin bloqueos ni dependencia de formatos propietarios.',
        ],
        [
            'title' => 'Permisos por equipo',
            'text' => 'Define quién edita, quién ve y quién opera en cada módulo según la gobernanza de tu empresa.',
        ],
    ],
    'faqs' => [
        [
        ...
        [
            ...
            'a' => 'Sí. Puedes suscribirte desde la página de precios con pago seguro en Stripe.',
        ],
        [
            'q' => '¿Los datos son míos?',
            'a' => 'Sí. Puedes exportar tu información cuando quieras. La plataforma se aloja en infraestructura europea robusta.',
        ],
        [
