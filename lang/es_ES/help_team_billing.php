...
return [
    ...
    'intro' => 'El consumo de tokens, WhatsApp y envíos de email se factura aparte de la cuota del plan. Cada equipo puede tener tarifas propias y frecuencia mensual o semanal. La página de Tarifas muestra un preview de lo que se debería facturar; Stripe aún no emite esas facturas.',
    ...
    'two_invoices_usage' => 'Consumo: tokens IA, envíos WhatsApp y envíos de email. Va en una factura de uso por equipo y periodo. Todavía no se emite en Stripe.',
    ...
    'rates_mailer' => 'Envío mail: EUR por cada email enviado, desde el primero. El plan cubre el uso de la plataforma y el límite de suscriptores, no los envíos. Por defecto 0,01 EUR.',
