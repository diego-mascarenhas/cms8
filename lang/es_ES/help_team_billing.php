...
return [
    ...
    'intro' => 'El consumo de tokens, WhatsApp y envíos de email se factura aparte de la cuota del plan. Cada equipo puede tener tarifas propias y frecuencia mensual o semanal. Al cerrar el ciclo se crea un draft en Stripe; no se cobra hasta que se finalice.',
    ...
    'two_invoices_usage' => 'Consumo: tokens IA, envíos WhatsApp y envíos de email. Va en una factura de uso por equipo y periodo. Al cierre se crea un draft en Stripe.',
    ...
    'status_not_issued' => 'Al cerrar un ciclo (o un ajuste de frecuencia) se crea un draft en Stripe. Hay que finalizarlo para cobrar.',
    'status_adjustments' => 'Al cambiar la frecuencia se guarda un ajuste pendiente (invoiced_at vacío). El barrido diario lo convierte en draft si hubo consumo.',
    'status_weeks' => 'Las semanas ya cerradas se convierten en draft en el barrido diario (hasta las dos últimas).',
    'status_mailer' => 'Se facturan todos los envíos del periodo. El límite de suscriptores del plan no resta emails de la factura.',
