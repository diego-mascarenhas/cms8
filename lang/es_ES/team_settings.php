...
return [
    ...
    'fields' => [
        ...
        'categories_allow_multiple_parents' => ['label' => 'Permitir varias categorías padre'],
        'categories_default_ordering' => ['label' => 'Orden por defecto'],
        'notifications_email_enabled' => ['label' => 'Notificaciones por email'],
        'notifications_sms_enabled' => ['label' => 'Notificaciones por SMS'],
        'notifications_from_name' => ['label' => 'Nombre del remitente', 'placeholder' => 'Nombre de tu empresa'],
        'notifications_from_email' => ['label' => 'Correo del remitente', 'placeholder' => 'notificaciones@tudominio.com'],
        'api_token_name' => ['label' => 'Nombre del token'],
        'api_token_abilities' => ['label' => 'Permisos del token'],
        'twilio_sid' => ['label' => 'Account SID'],
        'twilio_token' => ['label' => 'Auth Token'],
        'twilio_sms_from' => ['label' => 'Número SMS de origen'],
        'twilio_whatsapp_from' => ['label' => 'Número WhatsApp de origen'],
        'twilio_webhook_url' => ['label' => 'URL del webhook', 'help' => 'URL generada automáticamente para tu equipo. Configúrala en la consola de Twilio.'],
        'twilio_status_callback_url' => ['label' => 'URL de estado (callback)', 'help' => 'URL generada automáticamente para tu equipo. Configúrala en la consola de Twilio.'],
        'wordpress_url' => ['label' => 'URL del sitio', 'placeholder' => 'https://tu-sitio.com', 'help' => 'URL completa del sitio WordPress (sin /wp-json ni barra final).'],
        'wordpress_username' => ['label' => 'Usuario', 'placeholder' => 'admin', 'help' => 'Usuario de WordPress con permisos para editar entradas y páginas.'],
        'wordpress_application_password' => ['label' => 'Contraseña de aplicación', 'placeholder' => 'xxxx xxxx xxxx xxxx xxxx xxxx', 'help' => 'Generada en WordPress: Usuarios → tu usuario → Contraseñas de aplicación. Se almacena cifrada.'],
        'woocommerce_url' => ['label' => 'URL de la tienda', 'placeholder' => 'https://tu-tienda.com', 'help' => 'La URL completa de tu tienda WooCommerce.'],
        'woocommerce_api_version' => ['label' => 'Versión de la API'],
        'woocommerce_consumer_key' => ['label' => 'Consumer Key', 'placeholder' => 'ck_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', 'help' => 'Generada en WooCommerce > Ajustes > Avanzado > REST API.'],
        'woocommerce_consumer_secret' => ['label' => 'Consumer Secret', 'placeholder' => 'cs_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', 'help' => 'Generada en WooCommerce > Ajustes > Avanzado > REST API.'],
        'woocommerce_verify_ssl' => ['label' => 'Verificar certificado SSL', 'help' => 'Recomendado activar en producción con SSL válido.'],
        'email_plan_display' => ['label' => 'Plan actual', 'help' => 'Solo los administradores pueden cambiar el plan de email.'],
        'email_plan_description' => ['label' => 'Descripción del plan'],
        'email_monthly_limit' => ['label' => 'Límite mensual de emails', 'help' => 'Máximo de emails por mes.'],
        'email_monthly_used' => ['label' => 'Usados este mes'],
        'email_daily_limit' => ['label' => 'Límite diario de emails', 'help' => 'Máximo de emails por día (0 = ilimitado).'],
        'email_daily_used' => ['label' => 'Usados hoy'],
        'contact_limit' => ['label' => 'Límite de contactos', 'help' => 'Número máximo de contactos permitidos.'],
        'contact_count' => ['label' => 'Contactos actuales'],
        'email_monthly_reset_at' => ['label' => 'Fecha de reinicio mensual'],
        'email_daily_reset_date' => ['label' => 'Fecha de reinicio diario'],
        'analytics_credentials_json' => ['label' => 'Credenciales de cuenta de servicio (JSON)', 'placeholder' => 'Pega el JSON completo de Google Cloud Console...', 'help' => 'Crea una cuenta de servicio en Google Cloud, activa Google Analytics Data API y descarga la clave JSON.'],
        'analytics_property_id' => ['label' => 'ID de propiedad GA4', 'placeholder' => '123456789', 'help' => 'En Google Analytics: Administración > Detalles de la propiedad. Usa el ID numérico.'],
    ...
    'site_assistant' => [
        ...
        'intro' => 'Elige el prompt que usa el asistente cuando nadie más reclamó el turno (sin embudo ni comando de carrito). Está pensado para reservar citas, mostrar el catálogo y vender.',
        'help_link' => 'Ver ayuda',
        ...
        'create_help' => 'La plantilla ya cubre citas, catálogo y venta. Puedes editarla. El embudo y los comandos de WhatsApp (comprar, finalizar) siguen funcionando aparte.',
        ...
        'created' => 'Prompt creado y seleccionado. Copia el código de embed en la web del cliente.',
        ...
        'embed_help' => 'Pega este bloque antes de cerrar el body. El widget habla con el prompt elegido.',
        'embed_docs' => 'Instrucciones y endpoint en Ayuda',
        'embed_empty' => 'Selecciona o crea un prompt para generar el código de embed.',
