...
return [
    ...
    'intro' => 'Cuando tu equipo usá el correo saliente de la plataforma (SMTP del sistema), Humano comprueba el dominio de la dirección «De». Tu TXT SPF en el apex debe incluir el include de Revision Alpha (puedes mantener otros mecanismos: MX, ip4, otros include, etc.).',
    ...
    'domain_body' => 'La comprobación usá el dominio del remitente «De» configurado para tu equipo (Ajustes del equipo → correo / notificaciones). Si envías como noreply@ejemplo.com, el SPF se valida en ejemplo.com.',
    ...
    'includes_chain_body' => 'Si tu SPF usá include:otro-dominio y ese registro acaba incluyendo spf.revisionalpha.com, Humano sigue una cadena corta de includes (hasta 5 niveles) al resolver TXT.',
    ...
    'verify_body' => 'Usá un comprobador SPF/DNS externo para el apex de tu dominio, o consulta TXT desde terminal (ejemplo):',
