...
return [
    ...
    'login' => [
        ...
        'description' => 'Iniciá sesión con tu cuenta y comienza la aventura',
        'email' => 'Correo electrónico',
        'email_placeholder' => 'juan@ejemplo.com',
    ...
    'registration' => [
        ...
        'qr_whatsapp_service_unreachable' => 'No pudimos cargar el código QR en este momento. Esperá unos segundos o tocá «Actualizar código QR».',
        'qr_whatsapp_load_failed' => 'El código QR no apareció. Tocá «Actualizar código QR» para intentarlo de nuevo.',
        ...
        'checkout_start_failed' => 'No se pudo iniciar el pago. Reintenta o contactá con soporte.',
    ],
    'two_factor' => [
