                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="status" name="status" class="form-select" required>
                                        ...
                                        <option value="1" {{ isset($data) && $data->status == 1 ? 'selected' : '' }}>Suspended</option>
                                        <option value="2" {{ isset($data) && $data->status == 2 ? 'selected' : '' }}>To suspend</option>
                                        <option value="3" {{ isset($data) && $data->status == 3 ? 'selected' : '' }}>To activate</option>
                                        <option value="4" {{ isset($data) && $data->status == 4 ? 'selected' : '' }}>Active</option>
                                    </select>
                                </div>
                            </div>
