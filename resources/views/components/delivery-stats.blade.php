...
<div class="card mb-4">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <span class="badge bg-primary" data-bs-toggle="tooltip" data-bs-placement="top"
              title="Real-time statistics from database">
        ...
        @if(($stats->subscribers ?? 0) > 0)
            ...
            <div class="mt-4">
                ...
                <div class="progress mb-2" style="height: 8px;">
                    ...
                    <div class="progress-bar bg-info" style="width: {{ $deliveredPercent - $sentPercent }}%"></div>
                    <div class="progress-bar bg-warning" style="width: {{ $openedPercent - $deliveredPercent }}%"></div>
                </div>
