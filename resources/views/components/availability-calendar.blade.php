@props(['collaborator', 'weeklyAvailability', 'absences' => [], 'months' => []])
...
<div class="availability-calendar-component">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const weekdayToggles = document.querySelectorAll('.availability-calendar-component .btn-group button');
    ...
    function updateCalendarForWeekday(day, isUnavailable) {
        ...
        document.querySelectorAll('.availability-calendar-component .calendar-day:not(.day-disabled)').forEach(calendarDay => {
    ...
    const calendarDays = document.querySelectorAll('.availability-calendar-component .calendar-day:not(.day-disabled)');
