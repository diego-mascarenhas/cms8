                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($subscription->acceptedSLA)
                                            <i class="ti ti-check text-success" style="font-size: 1.5rem;" title="SLA aceptado el {{ $subscription->acceptedSLA->accepted_at->format('d/m/Y H:i') }}"></i>
                                        @else
                                            <span class="text-muted">—</span>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        @if($subscription->pendingSlaAcceptance)
