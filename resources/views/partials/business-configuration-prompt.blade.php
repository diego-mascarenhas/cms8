        ...
        <div class="d-flex align-items-center flex-wrap gap-2">
            ...
            <div class="flex-grow-1 min-w-0">
                @if ($needsBusinessConfig)
                    <span class="fw-medium d-block">{{ __('Complete your business configuration') }}</span>
                    <span class="small text-muted">{{ __('Add your business details in a few steps to get more out of Humano.') }}</span>
                @else
