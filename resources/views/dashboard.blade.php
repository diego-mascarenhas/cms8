    ...
    <div class="col-12 col-md-4 mb-4 mb-md-4 mb-lg-3 mb-sm-2">
        ...
        <div class="d-flex align-items-end row">
            ...
            <div class="card-body text-nowrap">
                <h5 class="card-title mb-0">Felicitaciones {{ explode(' ', auth()->user()->name)[0] }}! 🎉</h5>
  ...
  <div class="col-lg-6 col-md-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between">
        <h5 class="card-title m-0 me-2 pt-1 mb-2 d-flex align-items-center"><i class="ti ti-list-details ms-n1 me-2"></i> Actividad</h5>
        <div class="dropdown">
