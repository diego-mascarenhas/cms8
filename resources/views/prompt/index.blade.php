...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
    <div class="d-flex flex-column justify-content-center">
        <h4 class="mb-1 mt-3">Prompts</h4>
        <p class="text-muted">Manage and customize your prompts</p>
    </div>
    <div class="d-flex align-content-center flex-wrap gap-3">
        <a href="{{ route('prompt.create') }}" type="submit" class="btn btn-primary waves-effect waves-light">Create New</a>
    </div>
</div>
    ...
    function deleteRecord(id, element) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch("{{ route('prompt.destroy', ['id' => ':ID']) }}".replace(':ID', id), {
                    method: 'DELETE',
                    headers: {
