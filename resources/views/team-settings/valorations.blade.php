...
@include('team-settings.partials.header', [
    'team' => $team,
    'title' => __('Valorations'),
    'subtitle' => __('Manage contact valorations for your team'),
    'actions' => '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createValorationModal"><i class="ti ti-plus me-1"></i>'.e(__('Add Valoration')).'</button>',
])
