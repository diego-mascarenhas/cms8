  ...
  <div class="authentication-inner py-4">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <p>For details on cookies and similar technologies, see our <a href="{{ route('cookies') }}">Cookie Policy</a>.</p>
        ...
        <h3>5. Contact Us</h3>
        <p>If you have any questions about this Privacy Policy, please contact us at @include('legal.partials.support-link', ['label' => 'Support']).</p>
      </div>
    </div>
  </div>
</div>
