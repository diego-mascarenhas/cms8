...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
    <div class="d-flex flex-column justify-content-center">
        <h4 class="mb-1 mt-3">Suppliers</h4>
    ...
    <div class="d-flex align-content-center flex-wrap gap-3">
        <a href="{{ route('supplier.create') }}" type="submit" class="btn btn-primary waves-effect waves-light">Create New</a>
    </div>
</div>
...
<div id="toast-container" class="toast-top-right">
    <div class="toast toast-success" aria-live="polite" style="display: block;">
        <div class="toast-supplier">{{ session('success') }}</div>
    </div>
</div>
    ...
    function deleteRecord(id, element) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch("{{ route('supplier.destroy', ['id' => ':ID']) }}".replace(':ID', id), {
                    method: 'DELETE',
                    headers: {
                    ...
                    const toastHTML = `
                        <div id="toast-container" class="toast-top-right">
                            <div class="toast toast-success" aria-live="polite" style="display: block;">
                                <div class="toast-supplier">${data.success}</div>
                            </div>
                        </div>
                    `;
