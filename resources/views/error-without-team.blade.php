...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    ...
    <p class="mb-4 mx-2">You do not have permission to view this page without a team. <br> Please create one before continuing.</p>
    <a href="{{url('/teams/create')}}" class="btn btn-primary mb-4">Create team</a>
    <div class="mt-4">
