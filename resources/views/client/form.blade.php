...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
    <div class="d-flex flex-column justify-content-center">
		<h4 class="mb-1 mt-3"><span class="text-muted fw-light">Clients/</span> {{ isset($data) ? 'Edit' : 'Create' }}</h4>
...
<div class="card mb-4">
	...
	<form class="card-body" action="{{ route('client.store') }}" method="POST">
		...
		<div class="pt-4">
			...
			<button type="reset" class="btn btn-label-secondary" onclick="location.href='{{ route('app-client-list') }}'">Cancel</button>
		</div>
	</form>
</div>
@endsection