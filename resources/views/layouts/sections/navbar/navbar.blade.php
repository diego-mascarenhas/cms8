                        ...
                        <div class="dropdown-menu dropdown-menu-end py-0">
                            ...
                            <div class="dropdown-shortcuts-list scrollable-container">
                                <div class="row row-bordered overflow-visible g-0">
                                    ...
                                    <div class="dropdown-shortcuts-item col">
                                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                                            <i class="ti ti-layout-kanban fs-4"></i>
                                        </span>
                                        <a href="{{url('app/kanban')}}" class="stretched-link">Kanban</a>
                                        <small class="text-muted mb-0">Stay organized</small>
                                    </div>
                                </div>
                                <div class="row row-bordered overflow-visible g-0">
                                    <div class="dropdown-shortcuts-item col">
                                        ...
                                        <small class="text-muted mb-0">Talk with users</small>
                                    </div>
                                    <div class="dropdown-shortcuts-item col">
                                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                                            <i class="ti ti-mail fs-4"></i>
                                        </span>
                                        <a href="{{url('app/email')}}" class="stretched-link">Emails</a>
                                        <small class="text-muted mb-0">Your inbox</small>
                                    </div>
                                </div>
                                <div class="row row-bordered overflow-visible g-0">
                                    <div class="dropdown-shortcuts-item col">
                                        ...
                                        <a href="{{url('/')}}" class="stretched-link">QR</a>
                                        <small class="text-muted mb-0">Scan whit your mobile</small>
                                    </div>
                                    <div class="dropdown-shortcuts-item col">
                                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                                    ...
                                    <li
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0">Your CMS8 project application has been approved.</p>
