...
<link rel="stylesheet" href="{{ mix('assets/vendor/libs/datatables-bs5/datatables.bootstrap5.css') }}">
...
<script src="{{ mix('assets/vendor/libs/datatables-bs5/datatables-bootstrap5.js') }}"></script>
@endsection
